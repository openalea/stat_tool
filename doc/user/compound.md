...
Here is a brief description of the Compound class, which uses notions introduced in the [Histogram](./histogram.md) Section, recommended to be looked at first.
